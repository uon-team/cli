...
import { TagContentType, NAMED_ENTITIES, TagDefinition } from './html.tags';

import { ParseLocation, ParseSourceSpan, ParseSourceFile, InterpolationConfig, DEFAULT_INTERPOLATION_CONFIG, ParseError } from './parse.interfaces';
